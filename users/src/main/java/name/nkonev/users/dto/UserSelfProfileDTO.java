...
public class UserSelfProfileDTO extends UserAccountDTO {
    ...
    public UserSelfProfileDTO(
        Long id, String login, String avatar, String email, LocalDateTime lastLoginDateTime, OauthIdentifiersDTO oauthIdentifiers, Collection<UserRole> roles, Long expiresAt) {
